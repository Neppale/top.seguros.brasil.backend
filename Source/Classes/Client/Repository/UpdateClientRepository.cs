...
{
  public static GetClientDto? Update(int id, Cliente cliente, SqlConnection connectionString)
  {
    try
    {
      ...
      var client = connectionString.QueryFirstOrDefault<GetClientDto>("SELECT * FROM Clientes WHERE id_cliente = @Id", new { Id = id });
      return client;
    }
